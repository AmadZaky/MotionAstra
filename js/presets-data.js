window.MA_PRESETS = {
  ...
  "presets": [
    ...
    },
    {
      ...
      "name": "Liquid Gold",
      "category": "Text",
      "description": "A warm metallic gradient with a flowing distorted edge.",
      "parameters": [
        {
          "id": "amount",
          "label": "Intensity",
    ...
    },
    {
      ...
      "name": "3D Glass",
      "category": "Text",
      "description": "A cool glass-like bevel and drifting highlight; simulated depth.",
      "parameters": [
        {
          "id": "amount",
          "label": "Intensity",
    ...
    },
    {
      ...
      "name": "Gold Extrusion",
      "category": "Text",
      "description": "Gold shading with a native bevel and controllable drop-shadow depth.",
      "parameters": [
        {
          "id": "amount",
          "label": "Intensity",
