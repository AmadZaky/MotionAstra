...
for(const [mode,expected] of [[0,[0,100,50,0]],[1,[0,0,50,0]],[2,[0,100,150,200]]]){
...
console.log('PASS: real counter expressions implement Ping-Pong, Cycle and Continue, including boundaries.');
